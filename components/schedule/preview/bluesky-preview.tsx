        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 leading-none">
              ...
              <span className="text-[14px] font-bold">. 21h</span>
            </div>
            ...
            {images && images.length > 0 && (
              <div
                className={`mt-3 grid gap-1 overflow-hidden rounded-xl border border-border/50 ${images.length === 1 ? "grid-cols-1" : "grid-cols-2"}`}
              >
